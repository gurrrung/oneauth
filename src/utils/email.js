...
const verifyEmail = function (user, key) {
  ...
  const link = `https://account.codingblocks.com/verifyemail/key/${key}`
...
const forgotPassEmail = function (user, key) {
  ...
  const link = `https://account.codingblocks.com/forgot/password/new/${key}`
  msgTemplate.substitutions = {
...
// Send a Single Email to Single or Multiple Recipients
// where they don't see each others email addresses
